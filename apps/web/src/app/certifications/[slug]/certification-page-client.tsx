  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl font-bold mt-1">{cert.name} Practice Exam</h1>
        <p className="text-slate-600 dark:text-slate-400 mt-4 max-w-2xl">{cert.description}</p>
        <div className="flex gap-4 mt-4 text-sm text-slate-500">
          <span>{cert._count.questions} practice questions</span>
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-10">
          <Card>
            ...
            <h2 className="font-semibold text-lg">Practice Mode</h2>
          ...
          <Card>
            ...
            <h2 className="font-semibold text-lg">Timed Exam</h2>
          ...
          <Card>
            ...
            <h2 className="font-semibold text-lg">Review Mode</h2>
